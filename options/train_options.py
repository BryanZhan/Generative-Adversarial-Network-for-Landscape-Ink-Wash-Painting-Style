...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--lambda_sup', type=float, default=0.1, help='weight for cycle loss (A -> B -> A)')
        self.parser.add_argument('--lambda_ink', type=float, default=0.05, help='weight for ink loss ')
        self.parser.add_argument('--start_dec_sup', type=int, default=150, help='The iter to start decreasing lambda_sup')
